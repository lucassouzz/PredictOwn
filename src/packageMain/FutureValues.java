...
public class FutureValues {
	...
	public int getIdFutureValues() {
		return idFutureValues;
	}

	public void setIdFutureValues(int idFutureValues) {
		this.idFutureValues = idFutureValues;
	}
