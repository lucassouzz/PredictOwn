...
.ready(
		function() {
			...
			PREDICT.PATH = "/PredictOwn/rest/";
			
//			PREDICT.showAlert = function(alert) {
//				var modal = {
...
//			              "<p>Tipo de equipamento registrado com sucesso!</p>"+
//			            "</div>"+
...
//			          "</div>"
//				};
//				$("#modalAviso").html(alert);
//				$("#modalAviso").dialog(modal);
//			}
			
			

		PREDICT.loadDashBoard = function() {

		$('#ambientehtml').load("/PredictOwn/dashboard.html");
